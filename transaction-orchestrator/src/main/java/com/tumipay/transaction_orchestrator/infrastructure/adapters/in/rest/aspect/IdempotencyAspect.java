package com.tumipay.transaction_orchestrator.infrastructure.adapters.in.rest.aspect;
...
public class IdempotencyAspect {
    ...
    @Around("execution(* com.tumipay.transaction_orchestrator.infrastructure.adapters.in.rest.TransactionController.createTransaction(..)) && args(request)")
