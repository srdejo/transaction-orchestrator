package com.tumipay.transaction_orchestrator.infrastructure.adapters.outbound.persistence.adapter;
...
import com.tumipay.transaction_orchestrator.infrastructure.adapters.outbound.persistence.repository.CountryRepository;
import com.tumipay.transaction_orchestrator.infrastructure.adapters.outbound.persistence.repository.CurrencyRepository;
...
public class ReferenceDataCacheLoader {
    ...
    private final com.tumipay.transaction_orchestrator.infrastructure.adapters.outbound.persistence.repository.PaymentMethodRepository paymentMethodRepository;
