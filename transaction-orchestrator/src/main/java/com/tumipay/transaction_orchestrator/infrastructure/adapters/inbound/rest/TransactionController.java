package com.tumipay.transaction_orchestrator.infrastructure.adapters.inbound.rest;
...
public class TransactionController implements TransactionsApi {
    ...
    @Override
    public ResponseEntity<TransactionResponseWrapper> createTransaction(@RequestBody CreateTransactionRequest request) {
    ...
    @Override
    public ResponseEntity<TransactionResponseWrapper> getTransaction(@PathVariable("transaction_id") UUID transactionId) {
        Transaction transaction = getUseCase.execute(transactionId.toString());
        return ResponseEntity.ok(mapper.toResponse(transaction));
    }

    @Override
    public ResponseEntity<TransactionResponseWrapper> updateTransaction(@PathVariable("transaction_id") UUID transactionId, @RequestBody UpdateTransactionRequest request) {
